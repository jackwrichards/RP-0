    ...
    public class ScienceGUI : UIBase
    {
        ...
        private void RenderScienceGrid()
        {
            ...
            var experiments = new[]
            {
                ...
                new { Id = "RP0massSpec1", Name = "Mass", FullName = "Mass Spectrometry", Desc = "Possible with sounding rockets but slow. Only 8 science total." },
                new { Id = "RP0cosmicRay1", Name = "Cosmic", FullName = "Cosmic Ray Science", Desc = "Orbital science only. Unlocked at 62 total science." },
